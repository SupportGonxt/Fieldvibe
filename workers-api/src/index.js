...
export default {
  ...
  scheduled: async (event, env, ctx) => {
    ...
    // One-off live test tick — 14:45 SAST — remove once the digest is confirmed working end-to-end.
    if (sastHour === 14 && now.getUTCMinutes() === 45) await sendGoldrushTeamCockpitDigest(env, 'Test');

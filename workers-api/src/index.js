...
export default {
  ...
  scheduled: async (event, env, ctx) => {
    ...
    // One-off live test tick — 15:05 SAST — remove once the digest is confirmed working end-to-end.
    if (sastHour === 15 && now.getUTCMinutes() === 5) await sendGoldrushTeamCockpitDigest(env, 'Test');

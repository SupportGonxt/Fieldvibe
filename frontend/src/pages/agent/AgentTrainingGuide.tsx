    ...
    <div className="min-h-screen bg-[#06090F] pb-24">
      ...
      <div className="px-5 pt-6">
        <button
          ...
          className="w-full py-3.5 bg-gradient-to-r from-primary to-[#00D06E] text-[#0A1628] font-bold rounded-2xl shadow-lg shadow-primary/20 flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
        >

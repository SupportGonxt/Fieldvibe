        ...
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-3 rounded-xl border active:scale-95 transition-transform ${showHistory ? 'bg-primary/15 border-primary/40 text-primary' : 'bg-white/[0.04] border-white/10 text-gray-400'}`}

                  ...
                  {isExpanded && (
                    <div className="px-3 pb-3 pt-0 border-t border-token">
                      ...
                      <button
                        ...
                        className="w-full mt-2 min-h-[44px] py-2 bg-primary/10 border border-primary/20 rounded-lg text-xs font-semibold text-primary flex items-center justify-center gap-1.5"
                      >

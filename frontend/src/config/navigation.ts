...
export const navigation: NavigationItem[] = [
  ...
  // ═══════════════════ SECTION: OPERATIONS ═══════════════════
  {
    ...
    children: [
      ...
      { name: 'Stellr', href: '/field-operations/reports/stellr', permission: 'view_field_reports', description: 'Stellr store visit report with questionnaire data', group: 'Reports' },
    ],
  },
  {
    name: 'Van Sales',
